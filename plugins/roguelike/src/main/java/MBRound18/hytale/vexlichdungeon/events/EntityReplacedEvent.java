...
public final class EntityReplacedEvent extends DebugEvent {
  @Nonnull
  ...
  public EntityReplacedEvent(@Nonnull World world, @Nonnull Vector3d position, @Nonnull String modelId,
