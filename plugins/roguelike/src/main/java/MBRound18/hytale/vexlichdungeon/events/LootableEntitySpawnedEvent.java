...
public final class LootableEntitySpawnedEvent extends DebugEvent {
  @Nonnull
  ...
  public LootableEntitySpawnedEvent(@Nonnull World world, @Nonnull Vector3d position, @Nonnull String modelId,
