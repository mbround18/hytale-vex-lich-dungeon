...
public final class ReturnPortalRemovedEvent extends DebugEvent {
  @Nonnull
  ...
  public ReturnPortalRemovedEvent(@Nonnull World world, @Nonnull RoomCoordinate room, @Nonnull Vector3i position) {
