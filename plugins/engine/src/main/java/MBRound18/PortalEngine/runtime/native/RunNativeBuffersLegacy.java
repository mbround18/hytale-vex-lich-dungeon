package MBRound18.PortalEngine.runtime.offheap;
 ...
 */
@Deprecated
public final class RunNativeBuffersLegacy implements AutoCloseable {
  ...
  public RunNativeBuffersLegacy(int maxPlayers) {
