...
document.addEventListener("alpine:init", () => {
  Alpine.data("vexHeader", ({ variant = "home" } = {}) => ({
    ...
    async init() {
      ...
      if (config && config[this.variant] && Array.isArray(config[this.variant].links)) {
    ...
    buildLinks() {
      if (this.variant === "home") {
        return [
          ...
          { id: "dungeon", label: "The Dungeon", href: "#dungeon", type: "text" },
          { id: "rewards", label: "Rewards", href: "#rewards", type: "text" },
          { id: "enter", label: "Enter the Depths", href: "#download", type: "button" },
        ];
      }
      ...
      if (this.variant === "dev") {
        return [
          ...
          { id: "overview", label: "Overview", href: "/dev/", type: "link", active: true },
          { id: "grimoire", label: "UI Grimoire", href: "/dev/ui/", type: "link" },
          { id: "hosting", label: "Hosting", href: "/dev/hosting/", type: "link" },
          {
            id: "resources",
            label: "Resources",
            href: "#",
            type: "link",
            children: [
              { label: "Modding Template", href: "https://github.com/mbround18/hytale-modding-template" },
              {
          ...
          { id: "github", label: "GitHub", href: "https://github.com/mbround18", type: "pill" },
        ];
      }
      ...
      if (this.variant === "ui") {
        return [
          ...
          { id: "hosting", label: "Hosting", href: "/dev/hosting/", type: "link" },
          { id: "grimoire", label: "UI Grimoire", href: "/dev/ui/", type: "link", active: true },
          {
            id: "resources",
            label: "Resources",
            href: "#",
      ...
      if (this.variant === "hosting") {
        return [
          ...
          { id: "dev", label: "Dev Hub", href: "/dev/", type: "link" },
          { id: "grimoire", label: "UI Grimoire", href: "/dev/ui/", type: "link" },
          { id: "hosting", label: "Hosting", href: "/dev/hosting/", type: "link", active: true },
          {
            id: "resources",
            label: "Resources",
            href: "#",
