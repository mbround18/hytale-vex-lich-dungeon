...
public class GenerationConfig {
  ...
  public String toString() {
    return String.format(
        "GenerationConfig[radius=%d, tileSize=%d, roomProb=%.2f, tiles=%d, async=%b, batch=%d, seed=%d]",
        generationRadius, tileSize, roomProbability, calculateTotalTiles(),
        asyncGeneration, batchSize, seed);
  }
}
