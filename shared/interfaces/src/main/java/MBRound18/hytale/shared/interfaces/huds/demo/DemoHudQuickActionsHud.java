...
public class DemoHudQuickActionsHud extends AbstractCustomUIHud<DemosHudsDemohudquickactionsUi> {
  ...
  public DemoHudQuickActionsHud(
    ...
    super(DemosHudsDemohudquickactionsUi.class, store, ref, playerRef);
  }
}
