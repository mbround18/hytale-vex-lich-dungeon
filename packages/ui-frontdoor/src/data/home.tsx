...
export const homeContent = {
  ...
  lore: {
    ...
    paragraphs: [
      ...
      <>
        Now, he sits upon his throne of gears and bones, watching... waiting. He
        doesn&apos;t just want your life; he wants to test your wit. Only those
        who can navigate his mechanical horrors deserve the{" "}
        <span className="text-necro-green font-bold">
    ...
    features: [
      {
        ...
        description:
          "No two adventures are alike. Vex rearranges his lair every time you enter.",
        status: "active",
      },
      {
        step: "2",
        title: "Custom Mobs",
        description:
          "Clockwork skeletons and slime-infused zombies are being assembled in the workshop.",
        status: "coming",
      },
      {
        step: "3",
        ...
        description:
          "Vex is currently charging his ultimate spell. The final battle awaits.",
        status: "coming",
      },
  ...
  callToAction: {
    ...
    subtitle:
      "Vex is finalizing his traps. Star the repository to be notified when the dungeon opens.",
    actions: [
      {
