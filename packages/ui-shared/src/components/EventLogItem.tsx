...
export default function EventLogItem({ type, time, data, active, onClick }: EventLogItemProps) {
  return (
    <div
      onClick={onClick}
      className={`
    ...
    >
      <div className="flex justify-between items-center mb-1">
        <span className="text-[10px] font-bold text-violet-400 uppercase tracking-tight">{type}</span>
