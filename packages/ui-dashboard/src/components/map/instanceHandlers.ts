...
type InstanceHandler = {
  ...
  getRoomStyle: (room: RoomLike, inst: InstanceLike, defaults: RoomStyle) => RoomStyle;
};
...
export const getStyledRoom = (room: RoomLike, inst: InstanceLike, defaults: RoomStyle) => {
